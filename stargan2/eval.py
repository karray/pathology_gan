...
from stargan2.fid import calculate_fid_given_paths
from stargan2.lpips import calculate_lpips_given_images
from stargan2.data_loader import get_eval_loader
from stargan2 import utils
...
def calculate_metrics(nets, args, step, mode):
    ...
    for trg_idx, trg_domain in enumerate(domains):
        ...
        for src_idx, src_domain in enumerate(src_domains):
            ...
            for i, x_src in enumerate(loader_src):
                N = x_src.size(0)
