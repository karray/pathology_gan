...
class StyleEncoder(nn.Module):
    ...
    def forward(self, x, y):
        ...
        # h = self.fc(h.view(h.size(0), -1)) # 48x48

        # print(h.shape)
        # _, m, n = h.shape
        # nn.Linear(h, self.dim_out),
...
def build_model(img_size, style_dim, latent_dim, num_domains):
    G = Generator(img_size, style_dim)
    D = Discriminator(img_size, num_domains)
    ...
    return G, D, mapping_network, style_encoder
